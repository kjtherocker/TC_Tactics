...
template<> DESENTINTOATLANTIS_API UScriptStruct* StaticStruct<FEnemyGroupData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys_Inner = { "allEnemys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FEnemyEntityData, METADATA_PARAMS(nullptr, 0) }; // 2803085815
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys_MetaData[] = {
		{ "ModuleRelativePath", "Public/EnemyFactory.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys = { "allEnemys", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyFactory, allEnemys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys_MetaData)) }; // 2803085815
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups_Inner = { "allEnemysGroups", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FEnemyGroupData, METADATA_PARAMS(nullptr, 0) }; // 2138344842
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups_MetaData[] = {
		{ "ModuleRelativePath", "Public/EnemyFactory.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups = { "allEnemysGroups", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyFactory, allEnemysGroups), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups_MetaData)) }; // 2138344842
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_ValueProp = { "enemyMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FEnemyEntityData, METADATA_PARAMS(nullptr, 0) }; // 2803085815
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_Key_KeyProp = { "enemyMap_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_MetaData[] = {
		{ "ModuleRelativePath", "Public/EnemyFactory.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap = { "enemyMap", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyFactory, enemyMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_MetaData)) }; // 2803085815
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_ValueProp = { "enemyBestiaryData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UEnemyBestiaryData_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_Key_KeyProp = { "enemyBestiaryData_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_MetaData[] = {
		{ "ModuleRelativePath", "Public/EnemyFactory.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData = { "enemyBestiaryData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnemyFactory, enemyBestiaryData), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEnemyFactory_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemys,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_allEnemysGroups,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyMap,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEnemyFactory_Statics::NewProp_enemyBestiaryData,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEnemyFactory_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UEnemyFactory_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UEnemyFactory_Statics::PropPointers),
		0,
		0x001000A0u,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyFactory_h_Statics::ScriptStructInfo[] = {
		{ FEnemyGroupData::StaticStruct, Z_Construct_UScriptStruct_FEnemyGroupData_Statics::NewStructOps, TEXT("EnemyGroupData"), &Z_Registration_Info_UScriptStruct_EnemyGroupData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEnemyGroupData), 2138344842U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnemyFactory, UEnemyFactory::StaticClass, TEXT("UEnemyFactory"), &Z_Registration_Info_UClass_UEnemyFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnemyFactory), 1299440046U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DesentIntoAtlantis_Source_DesentIntoAtlantis_Public_EnemyFactory_h_720967029(TEXT("/Script/DesentIntoAtlantis"),
